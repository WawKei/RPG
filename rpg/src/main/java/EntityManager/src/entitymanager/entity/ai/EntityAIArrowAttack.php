...
use EntityManager\entity\IRangedAttackMob;
...
class EntityAIArrowAttack extends EntityAIBase{
	...
	public function __construct(IRangedAttackMob $attacker, float $movespeed, int $p_i1650_4_, int $maxAttackTime, float $maxAttackDistanceIn){
	...
	public function updateTask(){
		...
		$d0 = $this->entityHost->getDistanceSq($this->attackTarget->posX, $this->attackTarget->getEntityBoundingBox()->minY, $this->attackTarget->posZ);
