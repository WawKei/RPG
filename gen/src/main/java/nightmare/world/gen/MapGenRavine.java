                    ...
                    for (int j1 = k2; !flag2 && j1 < k; ++j1)
                    {
                        for (int k1 = i3; !flag2 && k1 < i1; ++k1)
                        {
                            for (int l1 = l + 1; !flag2 && l1 >= l2 - 1; --l1)
                            {
                                if (l1 >= 0 && l1 < 256)
                                {
                                    Block iblockstate = p_180707_5_.getBlockState(j1, l1, k1);
                            ...
                            for (int i2 = i3; i2 < i1; ++i2)
                            {
                                ...
                                if (d10 * d10 + d7 * d7 < 1.0D)
                                {
                                    for (int j2 = l; j2 > l2; --j2)
                                    {
                                        ...
                                        {
                                            Block iblockstate1 = p_180707_5_.getBlockState(j3, j2, i2);

                                            if (iblockstate1.getId() == Block.GRASS)
                                            {
                                                flag = true;
                                            }

                                            if (iblockstate1.getId() == Block.STONE || iblockstate1.getId() == Block.DIRT || iblockstate1.getId() == Block.GRASS)
                                            {
                                                if (j2 - 1 < 10)
                                                {
                                                    p_180707_5_.setBlockState(j3, j2, i2, Block.get(Block.STILL_LAVA));
                                                }
                                                else
                                                {
                                                    p_180707_5_.setBlockState(j3, j2, i2, Block.get(Block.AIR));

                                                    if (flag && p_180707_5_.getBlockState(j3, j2 - 1, i2).getId() == Block.DIRT)
                                                    {
                                                        blockpos$mutableblockpos.set(j3 + p_180707_3_ * 16, 0, i2 + p_180707_4_ * 16);
                                                        p_180707_5_.setBlockState(j3, j2 - 1, i2, this.world.getBiomeGenForCoords(blockpos$mutableblockpos).topBlock.clone());
                                                    }
                                                }
                                            }
                                        }
