...
public class MapGenCaves extends MapGenBase
{
                    ...
                    for (int j1 = k2; !flag3 && j1 < k; ++j1)
                    {
                        for (int k1 = i3; !flag3 && k1 < i1; ++k1)
                        {
                            for (int l1 = l + 1; !flag3 && l1 >= l2 - 1; --l1)
                            {
                                if (l1 >= 0 && l1 < 256)
                                {
                                    Block iblockstate = p_180702_5_.getBlockState(j1, l1, k1);

                                    if (iblockstate.getId() == Block.STILL_WATER || iblockstate.getId() == Block.WATER)
                                    {
                                        flag3 = true;
                                    }
                            ...
                            for (int i2 = i3; i2 < i1; ++i2)
                            {
                                ...
                                if (d10 * d10 + d8 * d8 < 1.0D)
                                {
                                    for (int j2 = l; j2 > l2; --j2)
                                    {
                                        ...
                                        {
                                            Block iblockstate1 = p_180702_5_.getBlockState(j3, j2, i2);
                                            Block iblockstate2 = p_180702_5_.getBlockState(j3, j2 + 1, i2);

                                            if (iblockstate1.getId() == Block.GRASS || iblockstate1.getId() == Block.MYCELIUM)
                                            {
                                                flag1 = true;
                                            }
                                            ...
                                            if (this.func_175793_a(iblockstate1, iblockstate2))
                                            {
                                                if (j2 - 1 < 10)
                                                {
                                                    p_180702_5_.setBlockState(j3, j2, i2, Block.get(Block.LAVA));
                                                }
                                                else
                                                {
                                                    p_180702_5_.setBlockState(j3, j2, i2, Block.get(Block.AIR));

                                                    if (iblockstate2.getId() == Block.SAND)
                                                    {
                                                        p_180702_5_.setBlockState(j3, j2 + 1, i2, iblockstate2.getDamage() == 0 ? Block.get(Block.SANDSTONE) : Block.get(Block.RED_SANDSTONE));
                                                    }

                                                    if (flag1 && p_180702_5_.getBlockState(j3, j2 - 1, i2).getId() == Block.DIRT)
                                                    {
                                                        blockpos$mutableblockpos.set(j3 + p_180702_3_ * 16, 0, i2 + p_180702_4_ * 16);
                                                        p_180702_5_.setBlockState(j3, j2 - 1, i2, this.world.getBiomeGenForCoords(blockpos$mutableblockpos).topBlock.clone());
                                                    }
                                                }
                                            }
                                        }
    ...
    protected boolean func_175793_a(Block p_175793_1_, Block p_175793_2_)
    {
        return p_175793_1_.getId() == Block.STONE ? true : (p_175793_1_.getId() == Block.DIRT ? true : (p_175793_1_.getId() == Block.GRASS ? true : (p_175793_1_.getId() == Block.CLAY_BLOCK ? true : (p_175793_1_.getId() == Block.STAINED_HARDENED_CLAY ? true : (p_175793_1_.getId() == Block.SANDSTONE ? true : (p_175793_1_.getId() == Block.RED_SANDSTONE ? true : (p_175793_1_.getId() == Block.MYCELIUM ? true : (p_175793_1_.getId() == Block.SNOW_LAYER ? true : (p_175793_1_.getId() == Block.SAND || p_175793_1_.getId() == Block.GRAVEL) && (p_175793_2_.getId() != Block.WATER && p_175793_2_.getId() != Block.STILL_WATER)))))))));
    }
