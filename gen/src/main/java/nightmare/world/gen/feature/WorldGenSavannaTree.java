...
{
    private static final Block field_181643_a = Block.get(Block.LOG2, BlockWood2.ACACIA);
    private static final Block field_181644_b = Block.get(Block.LEAVES2, BlockLeaves2.ACACIA);
                    ...
                    if (enumfacing1 != enumfacing)
                    {
                        ...
                        for (int l4 = l3; l4 < i && k4 > 0; --k4)
                        {
                            if (l4 >= 1)
                            {
                                ...
                                Block material1 = worldIn.getBlockState(blockpos1);

                                if (material1.getId() == Block.AIR || BlockHelper.isLeave(material1))
                                {
    ...
    {
        Block material = worldIn.getBlockState(p_175924_2_);
