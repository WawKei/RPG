...
{
    private static final Block field_181629_a = Block.get(Block.LOG, BlockWood.BIRCH);
    private static final Block field_181630_b = Block.get(Block.LEAVES, BlockLeaves.BIRCH);
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                if ((block1.getId() == Block.GRASS || block1.getId() == Block.DIRT || block1.getId() == Block.FARMLAND) && position.getY() < 256 - i - 1)
                {
                    ...
                    {
                        Block block2 = worldIn.getBlockState(position.up(j2));
