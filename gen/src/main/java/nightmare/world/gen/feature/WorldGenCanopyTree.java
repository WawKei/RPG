...
{
    private static final Block field_181640_a = Block.get(Block.LOG2, BlockWood2.DARK_OAK);
    private static final Block field_181641_b = Block.get(Block.LEAVES2, BlockLeaves2.DARK_OAK);
        ...
        if (k >= 1 && k + i + 1 < 256)
        {
            ...
            else
            {
                ...
                for (int j2 = 0; j2 < i; ++j2)
                {
                    ...
                    Block material = worldIn.getBlockState(blockpos1);
    ...
    private boolean func_181638_a(World p_181638_1_, BlockPos p_181638_2_, int p_181638_3_)
    {
        ...
        for (int l = 0; l <= p_181638_3_ + 1; ++l)
        {
            ...
            for (int j1 = -i1; j1 <= i1; ++j1)
            {
                ...
                {
                    if (!this.func_150523_a(p_181638_1_.getBlockState(blockpos$mutableblockpos.set(i + j1, j + l, k + k1))))
                    {
                        return false;
                    }
                }
    ...
    {
        if (this.func_150523_a(p_181639_1_.getBlockState(p_181639_2_)))
        {
