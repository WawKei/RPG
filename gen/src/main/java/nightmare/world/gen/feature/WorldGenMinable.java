...
public class WorldGenMinable extends WorldGenerator
{
    ...
    public WorldGenMinable(Block state, int blockCount)
    {
        this(state, blockCount, BlockHelper.forBlock(Block.get(Block.STONE)));
    }

    public WorldGenMinable(Block state, int blockCount, Predicate<Block> p_i45631_3_)
    {
        this.oreBlock = state;
