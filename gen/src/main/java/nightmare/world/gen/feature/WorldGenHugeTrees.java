...
public abstract class WorldGenHugeTrees extends WorldGenAbstractTree
{
    ...
    public WorldGenHugeTrees(boolean p_i46447_1_, int p_i46447_2_, int p_i46447_3_, Block p_i46447_4_, Block p_i46447_5_)
    {
        super(p_i46447_1_);
        ...
        if (p_175926_2_.getY() >= 1 && p_175926_2_.getY() + p_175926_3_ + 1 <= 256)
        {
            for (int i = 0; i <= 1 + p_175926_3_; ++i)
            {
                ...
                for (int k = -j; k <= j && flag; ++k)
                {
                    ...
                    {
                        if (p_175926_2_.getY() + i < 0 || p_175926_2_.getY() + i >= 256 || !this.func_150523_a(worldIn.getBlockState(p_175926_2_.add(k, i, l))))
                        {
                            flag = false;
                        }
                    }
    ...
    private boolean func_175927_a(BlockPos p_175927_1_, World worldIn)
    {
        ...
        if ((block.getId() == Block.GRASS || block.getId() == Block.DIRT) && p_175927_1_.getY() >= 2)
        {
