...
public class WorldGenBigMushroom extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        {
            this.mushroomType = rand.nextBoolean() ? Block.get(Block.BROWN_MUSHROOM_BLOCK) : Block.get(Block.RED_MUSHROOM_BLOCK);
        }
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 < 256)
        {
            ...
            else
            {
                ...
                if (block1.getId() != Block.DIRT && block1.getId() != Block.GRASS && block1.getId() != Block.MYCELIUM)
                {
                    return false;
                }
                else
                {
                    ...
                    if (this.mushroomType.getId() == Block.RED_MUSHROOM_BLOCK)
                    {
                    ...
                    for (int l2 = k2; l2 <= position.getY() + i; ++l2)
                    {
                        ...
                        if (this.mushroomType.getId() == Block.BROWN_MUSHROOM_BLOCK)
                        {
                            j3 = 3;
                        }
                    ...
                    {
                        Block block2 = worldIn.getBlockState(position.up(i3));
